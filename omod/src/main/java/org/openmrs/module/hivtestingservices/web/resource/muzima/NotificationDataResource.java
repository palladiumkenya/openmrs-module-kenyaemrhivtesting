...
import org.openmrs.module.hivtestingservices.model.NotificationData;
import org.openmrs.module.hivtestingservices.web.controller.MuzimaConstants;
import org.openmrs.module.hivtestingservices.web.resource.utils.JsonUtils;
...
import static org.openmrs.module.hivtestingservices.web.resource.utils.ResourceUtils.parseDate;
...
public class NotificationDataResource extends DataDelegatingCrudResource<NotificationData> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(org.openmrs.module.hivtestingservices.utils.JsonUtils.class.getSimpleName());
    /**
    ...
    /**
     * @see org.openmrs.module.webservices.rest.web.resource.api.Creatable#create(SimpleObject, RequestContext)
     */
    @Override
    ...
    private Date extractDateCreatedFromPayload(String payload){
        ...
        try {
            dateCreated = org.openmrs.module.hivtestingservices.utils.ISO8601Util.toCalendar(JsonUtils.readAsString(payload, "$['dateCreated']")).getTime();
