 ...
 */
@Handler(supports=RelatedPatientInCareDataDefinition.class, order=50)
public class RelatedPatientInCareDataEvaluator implements PatientContactDataEvaluator {
