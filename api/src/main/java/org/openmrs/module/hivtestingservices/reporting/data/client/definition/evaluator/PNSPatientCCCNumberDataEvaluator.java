 ...
 */
@Handler(supports=PNSPatientCCCNumberDataDefinition.class, order=50)
public class PNSPatientCCCNumberDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select t.encounter_id, IFNULL(l.ccc_number, '') ccc_number \n" +
