 ...
 */
@Handler(supports=RelatedPatientFacilityEnrolledDataDefinition.class, order=50)
public class RelatedPatientFacilityEnrolledDataEvaluator implements PatientContactDataEvaluator {
    ...
    public EvaluatedPatientContactData evaluate(PatientContactDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select c.patient_id, l.facility_linked_to  as facilityRelatedPatientIsEnrolled\n" +
