...
package org.openmrs.module.hivtestingservices.reporting.definition;
...
public class PatientContactDataSetDefinition extends RowPerObjectDataSetDefinition {
    ...
    private List<Mapped<? extends PatientContactQuery>> rowFilters;
    ...
    public List<Class<? extends DataDefinition>> getSupportedDataDefinitionTypes() {
        ...
        l.add(PatientContactDataDefinition.class);
    ...
    public void addColumn(String name, DataDefinition dataDefinition, String mappings, DataConverter... converters) {
        ...
        } else if (dataDefinition instanceof PatientContactDataDefinition) {
     ...
     */
    public void addRowFilter(PatientContactQuery filter, String mappings) {
        getRowFilters().add(new Mapped<PatientContactQuery>(filter, ParameterizableUtil.createParameterMappings(mappings)));
    }
     ...
     */
    public List<Mapped<? extends PatientContactQuery>> getRowFilters() {
        if (rowFilters == null) {
            rowFilters = new ArrayList<Mapped<? extends PatientContactQuery>>();
        }
        return rowFilters;
    }
     ...
     */
    public void setRowFilters(List<Mapped<? extends PatientContactQuery>> rowFilters) {
