...
public class PatientContactAgeDataEvaluator implements PatientContactDataEvaluator {
    ...
    public EvaluatedPatientContactData evaluate(PatientContactDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select c.patient_id, DATE_FORMAT(FROM_DAYS(DATEDIFF(CURDATE(),d.dob)), '%Y')+0 as age from kenyaemr_etl.etl_patient_contact c inner join kenyaemr_etl.etl_patient_demographics d on c.patient_id = d.patient_id where c.voided = 0;";
