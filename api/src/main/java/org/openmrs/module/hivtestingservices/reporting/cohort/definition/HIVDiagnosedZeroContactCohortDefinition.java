...
public class HIVDiagnosedZeroContactCohortDefinition extends BaseQuery<Encounter> implements EncounterQuery {
    ...
    public HIVDiagnosedZeroContactCohortDefinition() {
    }
