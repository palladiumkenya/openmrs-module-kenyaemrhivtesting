 ...
 */
@Handler(supports=PatientContactNameDataDefinition.class, order=50)
public class PatientContactNameDataEvaluator implements PatientContactDataEvaluator {
    ...
    public EvaluatedPatientContactData evaluate(PatientContactDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select patient_id, concat_ws(' ', d.given_name, d.family_name, middle_name) as fullName from kenyaemr_etl.etl_patient_demographics d where d.voided = 0; ";
