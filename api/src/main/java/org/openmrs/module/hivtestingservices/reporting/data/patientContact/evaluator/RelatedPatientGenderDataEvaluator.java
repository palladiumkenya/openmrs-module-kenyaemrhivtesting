 ...
 */
@Handler(supports=RelatedPatientGenderDataDefinition.class, order=50)
public class RelatedPatientGenderDataEvaluator implements PatientContactDataEvaluator {
    ...
    public EvaluatedPatientContactData evaluate(PatientContactDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select c.patient_id, d.Gender as Gender \n" +
