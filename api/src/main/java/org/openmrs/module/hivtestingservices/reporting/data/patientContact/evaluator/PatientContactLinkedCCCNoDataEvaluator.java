...
import org.openmrs.module.hivtestingservices.reporting.data.patientContact.definition.PatientContactLinkedCCCNoDataDefinition;
...
/**
 * Evaluates PatientContactLinkedCCCNoDataDefinition
 */
@Handler(supports = PatientContactLinkedCCCNoDataDefinition.class, order = 50)
public class PatientContactLinkedCCCNoDataEvaluator implements PatientContactDataEvaluator {
    ...
    public EvaluatedPatientContactData evaluate(PatientContactDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select c.id,\n" +
                ...
                "         left join (select p.patient_id, coalesce(p.unique_patient_no, l.ccc_number) as ccc_number\n" +
