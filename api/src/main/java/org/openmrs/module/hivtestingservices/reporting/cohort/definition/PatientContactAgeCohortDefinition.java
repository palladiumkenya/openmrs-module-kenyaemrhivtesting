...
@Localized("reporting.PatientContactAgeCohortDefinition")
public class PatientContactAgeCohortDefinition extends BaseCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public PatientContactAgeCohortDefinition() {
		super();
	}
	
	public PatientContactAgeCohortDefinition(Integer minAge, Integer maxAge, Date effectiveDate) {
		super();
		this.minAge = minAge;
		this.maxAge = maxAge;
