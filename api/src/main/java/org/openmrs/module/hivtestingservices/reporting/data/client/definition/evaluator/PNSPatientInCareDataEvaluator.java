 ...
 */
@Handler(supports=PNSPatientInCareDataDefinition.class, order=50)
public class PNSPatientInCareDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select t.encounter_id, IF(l.facility_linked_to is not null and l.ccc_number is not null, 'Y', 'N') isPatientEnrolled \n" +
