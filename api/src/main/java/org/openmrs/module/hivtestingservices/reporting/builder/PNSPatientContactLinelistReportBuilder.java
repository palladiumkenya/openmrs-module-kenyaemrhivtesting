...
@Component
@Builds({"kenyaemr.hts.common.report.pnsContactsWithUndocumentedStatus"})
public class PNSPatientContactLinelistReportBuilder extends AbstractHybridReportBuilder {
    ...
    protected DataSetDefinition datasetColumns() {
        ...
        dsd.setDescription("PNS Contact information");
        ...
        PNSContactsWithUndocumentedStatusCohortDefinition cd = new PNSContactsWithUndocumentedStatusCohortDefinition();
