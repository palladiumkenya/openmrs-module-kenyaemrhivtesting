 ...
 */
@Handler(supports=PatientContactLinkageToCareDataDefinition.class, order=50)
public class PatientContactLinkageToCareDataEvaluator implements PatientContactDataEvaluator {
    ...
    public EvaluatedPatientContactData evaluate(PatientContactDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT c.id, if(l.patient_id is not null,'Y','N') as contactLinked from kenyaemr_etl.etl_hts_referral_and_linkage l right join kenyaemr_hiv_testing_patient_contact c on l.patient_id=c.patient_id  \n" +
