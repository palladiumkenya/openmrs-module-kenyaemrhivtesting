...
@Component
@Builds({"kenyaemr.hts.common.report.snsContactsWithUndocumentedStatus"})
public class SNSPatientContactLinelistReportBuilder extends AbstractHybridReportBuilder {
    ...
    protected DataSetDefinition datasetColumns() {
        ...
        dsd.setDescription("SNS Contact information");
        ...
        SNSContactsWithUndocumentedStatusCohortDefinition cd = new SNSContactsWithUndocumentedStatusCohortDefinition();
