...
@Localized("reporting.familyTestingCohort")
public class FamilyTestingCohortDefinition extends BaseQuery<PatientContact> implements PatientContactQuery {
    ...
    public FamilyTestingCohortDefinition() {
    }
