 ...
 */
@Handler(supports=RelatedPatientVisitDateDataDefinition.class, order=50)
public class RelatedPatientVisitDateDataEvaluator implements PatientContactDataEvaluator {
