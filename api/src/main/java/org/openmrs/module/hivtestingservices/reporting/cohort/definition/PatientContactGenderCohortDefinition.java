...
@Localized("reporting.PatientContactGenderCohortDefinition")
public class PatientContactGenderCohortDefinition extends BaseCohortDefinition {
	 ...
	 * Default constructor
	 */
	public PatientContactGenderCohortDefinition() {
		super();
	}
